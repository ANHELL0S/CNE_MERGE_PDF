...
export function Header({ className = "", title, children }: Props) {
	...
	return (
		<header
			className={`p-8 w-full footer footer-center bg-base-100 ${className}`}
		>
			<SingleColumnLayout className="justify-center">
				<a href="/">
					<motion.h1 className="text-5xl font-black uppercase font-heading text-primary-header">
						<LogoIcon
				...
				<p className="text-center bg-base-100">{children}</p>
			</SingleColumnLayout>
		</header>
	);
}
